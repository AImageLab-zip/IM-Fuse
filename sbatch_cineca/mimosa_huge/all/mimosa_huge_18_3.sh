...
#SBATCH -e /leonardo/home/userexternal/ocarpent/slurm/outerr/mimosa_huge_18_3.err
#SBATCH -o /leonardo/home/userexternal/ocarpent/slurm/outerr/mimosa_huge_18_3.out
#SBATCH --gres=gpu:1
...
mimose train --config mimosa_huge_18.yaml --fold 3 --run-suffix fold3 --seed 0 --try-resume
mimose test --config mimosa_huge_18.yaml --fold 3 --run-suffix fold3 --fp16
