#!/bin/bash
#SBATCH --job-name=UHVED18_FOLD_5
...
#SBATCH -e /leonardo/home/userexternal/ocarpent/slurm/outerr/uhved_18_5.err
#SBATCH -o /leonardo/home/userexternal/ocarpent/slurm/outerr/uhved_18_5.out
#SBATCH --gres=gpu:1
...
mimose train --config uhved_18.yaml --fold 5 --run-suffix fold5 --seed 0 --try-resume
mimose test --config uhved_18.yaml --fold 5 --run-suffix fold5 --fp16
