...
#SBATCH -e /leonardo/home/userexternal/ocarpent/slurm/outerr/ims2trans_23_3.err
#SBATCH -o /leonardo/home/userexternal/ocarpent/slurm/outerr/ims2trans_23_3.out
#SBATCH --gres=gpu:1
...
mimose train --config ims2trans_23.yaml --fold 3 --run-suffix fold3 --seed 0 --try-resume
