#!/bin/bash
#SBATCH --job-name=SRMNET18_FOLD_5
...
#SBATCH -e /leonardo/home/userexternal/ocarpent/slurm/outerr/srmnet_18_5.err
#SBATCH -o /leonardo/home/userexternal/ocarpent/slurm/outerr/srmnet_18_5.out
#SBATCH --gres=gpu:1
...
mimose train --config srmnet_18.yaml --fold 5 --run-suffix fold5 --seed 0 --try-resume
mimose test --config srmnet_18.yaml --fold 5 --run-suffix fold5 --fp16
