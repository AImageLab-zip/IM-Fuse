#!/bin/bash
#SBATCH --job-name=M3FECON18_FOLD_3
...
#SBATCH -e /leonardo/home/userexternal/ocarpent/slurm/outerr/m3fecon_18_3.err
#SBATCH -o /leonardo/home/userexternal/ocarpent/slurm/outerr/m3fecon_18_3.out
#SBATCH --gres=gpu:1
...
mimose train --config m3fecon_18.yaml --fold 3 --run-suffix fold3 --seed 0 --try-resume
mimose test --config m3fecon_18.yaml --fold 3 --run-suffix fold3 --fp16
