...
#SBATCH --mem=150G
#SBATCH --time=6:00:00
#SBATCH -e /leonardo/home/userexternal/ocarpent/slurm/outerr/preprocessing.err
#SBATCH -o /leonardo/home/userexternal/ocarpent/slurm/outerr/preprocessing.out
#SBATCH --gres=gpu:0
