...
#SBATCH -e /leonardo/home/userexternal/ocarpent/slurm/outerr/mstkdnet_18_fold5_test.err
#SBATCH -o /leonardo/home/userexternal/ocarpent/slurm/outerr/mstkdnet_18_fold5_test.out
#SBATCH --gres=gpu:1
