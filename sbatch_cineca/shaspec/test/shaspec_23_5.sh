...
#SBATCH -e /leonardo/home/userexternal/ocarpent/slurm/outerr/shaspec_23_fold5_test.err
#SBATCH -o /leonardo/home/userexternal/ocarpent/slurm/outerr/shaspec_23_fold5_test.out
#SBATCH --gres=gpu:1
