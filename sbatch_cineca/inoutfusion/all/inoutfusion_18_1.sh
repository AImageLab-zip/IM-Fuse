#!/bin/bash
#SBATCH --job-name=INOUTFUSION18_FOLD_1
...
#SBATCH -e /leonardo/home/userexternal/ocarpent/slurm/outerr/inoutfusion_18_1.err
#SBATCH -o /leonardo/home/userexternal/ocarpent/slurm/outerr/inoutfusion_18_1.out
#SBATCH --gres=gpu:1
...
mimose train --config inoutfusion_18.yaml --fold 1 --run-suffix fold1 --seed 0 --try-resume
