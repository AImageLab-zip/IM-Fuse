...
#SBATCH -e /leonardo/home/userexternal/ocarpent/slurm/outerr/inoutfusion_18_test.err
#SBATCH -o /leonardo/home/userexternal/ocarpent/slurm/outerr/inoutfusion_18_test.out
#SBATCH --gres=gpu:1
