...
#SBATCH -e /leonardo/home/userexternal/ocarpent/slurm/outerr/inoutfusion_23_67.err
#SBATCH -o /leonardo/home/userexternal/ocarpent/slurm/outerr/inoutfusion_23_67.out
#SBATCH --gres=gpu:1
