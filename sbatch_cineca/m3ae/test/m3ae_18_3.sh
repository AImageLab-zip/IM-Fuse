...
#SBATCH -e /leonardo/home/userexternal/ocarpent/slurm/outerr/m3ae_18_fold3_test.err
#SBATCH -o /leonardo/home/userexternal/ocarpent/slurm/outerr/m3ae_18_fold3_test.out
#SBATCH --gres=gpu:1
