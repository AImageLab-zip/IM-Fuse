...
#SBATCH -e /leonardo/home/userexternal/ocarpent/slurm/outerr/m3ae_18_5.err
#SBATCH -o /leonardo/home/userexternal/ocarpent/slurm/outerr/m3ae_18_5.out
#SBATCH --gres=gpu:1
...
mimose train --config m3ae_18.yaml --fold 5 --run-suffix fold5 --seed 0 --try-resume
mimose test --config m3ae_18.yaml --fold 5 --run-suffix fold5
