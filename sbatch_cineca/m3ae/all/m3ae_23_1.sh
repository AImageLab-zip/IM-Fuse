...
#SBATCH -e /leonardo/home/userexternal/ocarpent/slurm/outerr/m3ae_23_1.err
#SBATCH -o /leonardo/home/userexternal/ocarpent/slurm/outerr/m3ae_23_1.out
#SBATCH --gres=gpu:1
...
mimose train --config m3ae_23.yaml --fold 1 --run-suffix fold1 --seed 0 --try-resume
mimose test --config m3ae_23.yaml --fold 1 --run-suffix fold1
