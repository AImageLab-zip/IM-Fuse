#!/bin/bash
#SBATCH --job-name=MMFMR23_FOLD_3
...
#SBATCH -e /leonardo/home/userexternal/ocarpent/slurm/outerr/mmformer_23_3.err
#SBATCH -o /leonardo/home/userexternal/ocarpent/slurm/outerr/mmformer_23_3.out
#SBATCH --gres=gpu:1
...
mimose train --config mmformer_23.yaml --fold 3 --run-suffix fold3 --seed 0 --try-resume
mimose test --config mmformer_23.yaml --fold 3 --run-suffix fold3 --fp16
