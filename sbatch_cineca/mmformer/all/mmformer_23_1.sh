#!/bin/bash
#SBATCH --job-name=MMFMR23_FOLD_1
...
#SBATCH -e /leonardo/home/userexternal/ocarpent/slurm/outerr/mmformer_23_1.err
#SBATCH -o /leonardo/home/userexternal/ocarpent/slurm/outerr/mmformer_23_1.out
#SBATCH --gres=gpu:1
...
mimose train --config mmformer_23.yaml --fold 1 --run-suffix fold1 --seed 0 --try-resume
mimose test --config mmformer_23.yaml --fold 1 --run-suffix fold1 --fp16
