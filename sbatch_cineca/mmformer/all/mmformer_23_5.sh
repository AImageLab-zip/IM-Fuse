#!/bin/bash
#SBATCH --job-name=MMFMR23_FOLD_5
...
#SBATCH -e /leonardo/home/userexternal/ocarpent/slurm/outerr/mmformer_23_5.err
#SBATCH -o /leonardo/home/userexternal/ocarpent/slurm/outerr/mmformer_23_5.out
#SBATCH --gres=gpu:1
...
mimose train --config mmformer_23.yaml --fold 5 --run-suffix fold5 --seed 0 --try-resume
mimose test --config mmformer_23.yaml --fold 5 --run-suffix fold5 --fp16
