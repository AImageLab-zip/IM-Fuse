#!/bin/bash
#SBATCH --job-name=MMFMR18_SEED_67
...
#SBATCH -e /leonardo/home/userexternal/ocarpent/slurm/outerr/mmformer_18_67.err
#SBATCH -o /leonardo/home/userexternal/ocarpent/slurm/outerr/mmformer_18_67.out
#SBATCH --gres=gpu:1
