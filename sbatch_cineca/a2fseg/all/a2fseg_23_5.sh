#!/bin/bash
#SBATCH --job-name=A2FSEG23_FOLD_5
...
#SBATCH -e /leonardo/home/userexternal/ocarpent/slurm/outerr/a2fseg_23_5.err
#SBATCH -o /leonardo/home/userexternal/ocarpent/slurm/outerr/a2fseg_23_5.out
#SBATCH --gres=gpu:1
...
mimose train --config a2fseg_23.yaml --fold 5 --run-suffix fold5 --seed 0 --try-resume
mimose test --config a2fseg_23.yaml --fold 5 --run-suffix fold5 --fp16
