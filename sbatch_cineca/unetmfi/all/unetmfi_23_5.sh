#!/bin/bash
#SBATCH --job-name=UNETMFI23_FOLD_5
...
#SBATCH -e /leonardo/home/userexternal/ocarpent/slurm/outerr/unetmfi_23_5.err
#SBATCH -o /leonardo/home/userexternal/ocarpent/slurm/outerr/unetmfi_23_5.out
#SBATCH --gres=gpu:1
