#!/bin/bash
#SBATCH --job-name=DCSEG23_FOLD_1
...
#SBATCH -e /leonardo/home/userexternal/ocarpent/slurm/outerr/dcseg_23_1.err
#SBATCH -o /leonardo/home/userexternal/ocarpent/slurm/outerr/dcseg_23_1.out
#SBATCH --gres=gpu:1
...
mimose train --config dcseg_23.yaml --fold 1 --run-suffix fold1 --seed 0 --try-resume
mimose test --config dcseg_23.yaml --fold 1 --run-suffix fold1 --fp16
