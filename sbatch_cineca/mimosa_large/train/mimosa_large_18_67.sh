#!/bin/bash
#SBATCH --job-name=MIMOSA_LARGE18_SEED_67
...
#SBATCH -e /leonardo/home/userexternal/ocarpent/slurm/outerr/mimosa_large_18_67.err
#SBATCH -o /leonardo/home/userexternal/ocarpent/slurm/outerr/mimosa_large_18_67.out
#SBATCH --gres=gpu:2
