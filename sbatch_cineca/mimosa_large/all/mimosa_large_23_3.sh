...
#SBATCH -e /leonardo/home/userexternal/ocarpent/slurm/outerr/mimosa_large_23_3.err
#SBATCH -o /leonardo/home/userexternal/ocarpent/slurm/outerr/mimosa_large_23_3.out
#SBATCH --gres=gpu:1
...
mimose train --config mimosa_large_23.yaml --fold 3 --run-suffix fold3 --seed 0 --try-resume
