...
#SBATCH -e /leonardo/home/userexternal/ocarpent/slurm/outerr/sfusion_18_5.err
#SBATCH -o /leonardo/home/userexternal/ocarpent/slurm/outerr/sfusion_18_5.out
#SBATCH --gres=gpu:1
...
mimose test --config sfusion_18.yaml --fold 5 --run-suffix fold5 --fp16
