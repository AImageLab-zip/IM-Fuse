...
#SBATCH -e /leonardo/home/userexternal/ocarpent/slurm/outerr/sfusion_23_5.err
#SBATCH -o /leonardo/home/userexternal/ocarpent/slurm/outerr/sfusion_23_5.out
#SBATCH --gres=gpu:1
...
mimose train --config sfusion_23.yaml --fold 5 --run-suffix fold5 --seed 0 --try-resume
mimose test --config sfusion_23.yaml --fold 5 --run-suffix fold5 --fp16
