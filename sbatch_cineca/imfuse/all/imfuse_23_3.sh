#!/bin/bash
#SBATCH --job-name=IM_FUSO23_FOLD_3
...
#SBATCH -e /leonardo/home/userexternal/ocarpent/slurm/outerr/imfuse_23_3.err
#SBATCH -o /leonardo/home/userexternal/ocarpent/slurm/outerr/imfuse_23_3.out
#SBATCH --gres=gpu:1
...
mimose train --config imfuse_23.yaml --fold 3 --run-suffix fold3 --seed 0 --try-resume
mimose test --config imfuse_23.yaml --fold 3 --run-suffix fold3 
