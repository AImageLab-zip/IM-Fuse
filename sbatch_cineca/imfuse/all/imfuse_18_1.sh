#!/bin/bash
#SBATCH --job-name=IM_FUSO18_FOLD_1
...
#SBATCH -e /leonardo/home/userexternal/ocarpent/slurm/outerr/imfuse_18_1.err
#SBATCH -o /leonardo/home/userexternal/ocarpent/slurm/outerr/imfuse_18_1.out
#SBATCH --gres=gpu:1
