#!/bin/bash
#SBATCH --job-name=MMMVIT23_FOLD_1
...
#SBATCH -e /leonardo/home/userexternal/ocarpent/slurm/outerr/mmmvit_23_1.err
#SBATCH -o /leonardo/home/userexternal/ocarpent/slurm/outerr/mmmvit_23_1.out
#SBATCH --gres=gpu:1
