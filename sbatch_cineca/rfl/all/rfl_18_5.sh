...
#SBATCH -e /leonardo/home/userexternal/ocarpent/slurm/outerr/rfl_18_5.err
#SBATCH -o /leonardo/home/userexternal/ocarpent/slurm/outerr/rfl_18_5.out
#SBATCH --gres=gpu:1
...
mimose train --config rfl_18.yaml --fold 5 --run-suffix fold5 --seed 0 --try-resume
mimose test --config rfl_18.yaml --fold 5 --run-suffix fold5 --fp16
