#!/bin/bash
#SBATCH --job-name=MIMOSA_GARGANTUAN23_FOLD_3
...
#SBATCH -e /leonardo/home/userexternal/ocarpent/slurm/outerr/mimosa_gargantuan_23_3.err
#SBATCH -o /leonardo/home/userexternal/ocarpent/slurm/outerr/mimosa_gargantuan_23_3.out
#SBATCH --gres=gpu:2
...
mimose train --config mimosa_gargantuan_23.yaml --fold 3 --run-suffix fold3 --seed 0 --try-resume --num-workers 60 --distributed
