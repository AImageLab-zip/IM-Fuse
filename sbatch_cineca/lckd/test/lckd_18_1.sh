...
#SBATCH -e /leonardo/home/userexternal/ocarpent/slurm/outerr/lckd_18_fold1_test.err
#SBATCH -o /leonardo/home/userexternal/ocarpent/slurm/outerr/lckd_18_fold1_test.out
#SBATCH --gres=gpu:1
