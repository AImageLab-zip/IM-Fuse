...
# Compute paths without importing from mimose (which is slow)
def _get_config_dir() -> Path:
    """Get configs dir without importing mimose modules."""
    package_root = Path(__file__).resolve().parent
    return package_root / "data" / "configs"


def _get_splits_dir() -> Path:
    """Get splits dir without importing mimose modules."""
    package_root = Path(__file__).resolve().parent
