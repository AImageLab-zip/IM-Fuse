#!/bin/bash
#SBATCH --job-name=MIMOSA_SMALL18_TEST_INTERNAL
...
#SBATCH -e /homes/ocarpentiero/slurm/outerr/mimosa_small_18_test_internal.err
#SBATCH -o /homes/ocarpentiero/slurm/outerr/mimosa_small_18_test_internal.out
#SBATCH --gres=gpu:1
...
# Tests the brats18-trained mimosa_small checkpoints (folds 1/3/5) against
