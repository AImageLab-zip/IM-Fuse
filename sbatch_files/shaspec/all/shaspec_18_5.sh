...
#SBATCH -e /homes/ocarpentiero/slurm/outerr/shaspec_18_5.err
#SBATCH -o /homes/ocarpentiero/slurm/outerr/shaspec_18_5.out
#SBATCH --gres=gpu:1
...
mimose test --config shaspec_18.yaml --fold 5 --run-suffix fold5 --fp16
