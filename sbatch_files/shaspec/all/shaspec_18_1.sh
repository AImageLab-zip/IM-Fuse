...
#SBATCH -e /homes/ocarpentiero/slurm/outerr/shaspec_18_1.err
#SBATCH -o /homes/ocarpentiero/slurm/outerr/shaspec_18_1.out
#SBATCH --gres=gpu:1
...
mimose test --config shaspec_18.yaml --fold 1 --run-suffix fold1 --fp16
