...
mimose preprocess --input-dir /work/phd_mimose/internal_raw/internal_cropped --output-dir /work/phd_mimose/internal_raw/manymimosaskd_internal --crop-mode none --clamp-mode none --norm-mode subject_zscore --yes
