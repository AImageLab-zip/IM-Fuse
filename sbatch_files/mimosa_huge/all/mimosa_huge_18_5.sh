...
#SBATCH -e /homes/ocarpentiero/slurm/outerr/mimosa_huge_18_5.err
#SBATCH -o /homes/ocarpentiero/slurm/outerr/mimosa_huge_18_5.out
#SBATCH --gres=gpu:1
...
mimose train --config mimosa_huge_18.yaml --fold 5 --run-suffix fold5 --seed 0 --try-resume
mimose test --config mimosa_huge_18.yaml --fold 5 --run-suffix fold5 --fp16
