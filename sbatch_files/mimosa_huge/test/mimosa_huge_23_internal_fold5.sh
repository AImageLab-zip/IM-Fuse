#!/bin/bash
#SBATCH --job-name=MIMOSA_HUGE23_TEST_INTERNAL_FOLD5
...
#SBATCH -e /homes/ocarpentiero/slurm/outerr/mimosa_huge_23_test_internal_fold5.err
#SBATCH -o /homes/ocarpentiero/slurm/outerr/mimosa_huge_23_test_internal_fold5.out
#SBATCH --gres=gpu:1
...
# Tests the brats23-trained mimosa_huge checkpoint (fold 5) against
