#!/bin/bash
#SBATCH --job-name=MIMOSA_HUGE18_TEST_INTERNAL_FOLD1
...
#SBATCH -e /homes/ocarpentiero/slurm/outerr/mimosa_huge_18_test_internal_fold1.err
#SBATCH -o /homes/ocarpentiero/slurm/outerr/mimosa_huge_18_test_internal_fold1.out
#SBATCH --gres=gpu:1
...
# Tests the brats18-trained mimosa_huge checkpoint (fold 1) against
