#!/bin/bash
#SBATCH --job-name=SFUSION23_TEST_INTERNAL
...
#SBATCH -e /homes/ocarpentiero/slurm/outerr/sfusion_23_test_internal.err
#SBATCH -o /homes/ocarpentiero/slurm/outerr/sfusion_23_test_internal.out
#SBATCH --gres=gpu:1
...
# Tests the brats23-trained sfusion checkpoints (folds 1/3/5) against
