...
mimose train --config sfusion_23.yaml --fold 3 --run-suffix fold3 --seed 0 --try-resume --distributed
mimose test --config sfusion_23.yaml --fold 3 --run-suffix fold3
