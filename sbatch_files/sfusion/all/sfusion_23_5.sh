...
#SBATCH -e /homes/ocarpentiero/slurm/outerr/sfusion_23_5.err
#SBATCH -o /homes/ocarpentiero/slurm/outerr/sfusion_23_5.out
#SBATCH --gres=gpu:2
...
mimose train --config sfusion_23.yaml --fold 5 --run-suffix fold5 --seed 0 --try-resume --distributed
mimose test --config sfusion_23.yaml --fold 5 --run-suffix fold5
