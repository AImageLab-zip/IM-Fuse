#!/bin/bash
#SBATCH --job-name=MIMOSA_MICRO23_TEST_INTERNAL_FOLD1
...
#SBATCH -e /homes/ocarpentiero/slurm/outerr/mimosa_micro_23_test_internal_fold1.err
#SBATCH -o /homes/ocarpentiero/slurm/outerr/mimosa_micro_23_test_internal_fold1.out
#SBATCH --gres=gpu:1
...
# Tests the brats23-trained mimosa_micro checkpoint (fold 1) against
