#!/bin/bash
#SBATCH --job-name=MIMOSA_MICRO23_TEST_INTERNAL_FOLD3
...
#SBATCH -e /homes/ocarpentiero/slurm/outerr/mimosa_micro_23_test_internal_fold3.err
#SBATCH -o /homes/ocarpentiero/slurm/outerr/mimosa_micro_23_test_internal_fold3.out
#SBATCH --gres=gpu:1
...
# Tests the brats23-trained mimosa_micro checkpoint (fold 3) against
