#!/bin/bash
#SBATCH --job-name=MIMOSA_MICRO18_TEST_INTERNAL
...
#SBATCH -e /homes/ocarpentiero/slurm/outerr/mimosa_micro_18_test_internal.err
#SBATCH -o /homes/ocarpentiero/slurm/outerr/mimosa_micro_18_test_internal.out
#SBATCH --gres=gpu:1
...
# Tests the brats18-trained mimosa_micro checkpoints (folds 1/3/5) against
