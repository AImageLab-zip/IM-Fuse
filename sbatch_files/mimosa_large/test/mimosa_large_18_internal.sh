#!/bin/bash
#SBATCH --job-name=MIMOSA_LARGE18_TEST_INTERNAL
...
#SBATCH -e /homes/ocarpentiero/slurm/outerr/mimosa_large_18_test_internal.err
#SBATCH -o /homes/ocarpentiero/slurm/outerr/mimosa_large_18_test_internal.out
#SBATCH --gres=gpu:2
...
# Tests the brats18-trained mimosa_large checkpoints (folds 1/3/5) against
