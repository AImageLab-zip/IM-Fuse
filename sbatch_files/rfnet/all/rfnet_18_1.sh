...
#SBATCH -e /homes/ocarpentiero/slurm/outerr/rfnet_18_1.err
#SBATCH -o /homes/ocarpentiero/slurm/outerr/rfnet_18_1.out
#SBATCH --gres=gpu:1
...
mimose test --config rfnet_18.yaml --fold 1 --run-suffix fold1 
