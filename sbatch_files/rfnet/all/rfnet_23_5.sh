...
#SBATCH -e /homes/ocarpentiero/slurm/outerr/rfnet_23_5.err
#SBATCH -o /homes/ocarpentiero/slurm/outerr/rfnet_23_5.out
#SBATCH --gres=gpu:1
...
mimose test --config rfnet_23.yaml --fold 5 --run-suffix fold5 
