...
mimose preprocess --input-dir /work/phd_mimose/internal_raw/internal_cropped --output-dir /work/phd_mimose/internal_raw/dcseg_internal --crop-mode non_empty --crop-min-size 128 128 128 --clamp-mode none --norm-mode subject_zscore --yes
