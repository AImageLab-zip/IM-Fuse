#!/bin/bash
#SBATCH --job-name=MIMOSA_MEDIUM18_TEST_INTERNAL
...
#SBATCH -e /homes/ocarpentiero/slurm/outerr/mimosa_medium_18_test_internal.err
#SBATCH -o /homes/ocarpentiero/slurm/outerr/mimosa_medium_18_test_internal.out
#SBATCH --gres=gpu:1
...
# Tests the brats18-trained mimosa_medium checkpoints (folds 1/3/5) against
