#!/bin/bash
#SBATCH --job-name=MIMOSA_MEDIUM23_TEST_INTERNAL
...
#SBATCH -e /homes/ocarpentiero/slurm/outerr/mimosa_medium_23_test_internal.err
#SBATCH -o /homes/ocarpentiero/slurm/outerr/mimosa_medium_23_test_internal.out
#SBATCH --gres=gpu:1
...
# Tests the brats23-trained mimosa_medium checkpoints (folds 1/3/5) against
