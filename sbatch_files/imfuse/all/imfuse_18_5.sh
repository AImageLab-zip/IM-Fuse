#!/bin/bash
#SBATCH --job-name=IM_FUSO18_FOLD_5
...
#SBATCH -e /homes/ocarpentiero/slurm/outerr/imfuse_18_5.err
#SBATCH -o /homes/ocarpentiero/slurm/outerr/imfuse_18_5.out
#SBATCH --gres=gpu:1
...
mimose test --config imfuse_18.yaml --fold 5 --run-suffix fold5 --fp16
