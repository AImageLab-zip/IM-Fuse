#!/bin/bash
#SBATCH --job-name=MIMOSA_TINY18_TEST_INTERNAL
...
#SBATCH -e /homes/ocarpentiero/slurm/outerr/mimosa_tiny_18_test_internal.err
#SBATCH -o /homes/ocarpentiero/slurm/outerr/mimosa_tiny_18_test_internal.out
#SBATCH --gres=gpu:1
...
# Tests the brats18-trained mimosa_tiny checkpoints (folds 1/3/5) against
