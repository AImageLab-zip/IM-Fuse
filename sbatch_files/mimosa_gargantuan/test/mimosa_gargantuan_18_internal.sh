#!/bin/bash
#SBATCH --job-name=MIMOSA_GARGANTUAN18_TEST_INTERNAL
...
#SBATCH -e /homes/ocarpentiero/slurm/outerr/mimosa_gargantuan_18_test_internal.err
#SBATCH -o /homes/ocarpentiero/slurm/outerr/mimosa_gargantuan_18_test_internal.out
#SBATCH --gres=gpu:2
...
# Tests the brats18-trained mimosa_gargantuan checkpoints (folds 1/3/5) against
