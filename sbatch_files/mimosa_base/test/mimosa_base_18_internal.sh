#!/bin/bash
#SBATCH --job-name=MIMOSA_BASE18_TEST_INTERNAL
...
#SBATCH -e /homes/ocarpentiero/slurm/outerr/mimosa_base_18_test_internal.err
#SBATCH -o /homes/ocarpentiero/slurm/outerr/mimosa_base_18_test_internal.out
#SBATCH --gres=gpu:2
...
# Tests the brats18-trained mimosa_base checkpoints (folds 1/3/5) against
