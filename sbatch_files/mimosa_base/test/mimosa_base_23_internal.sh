#!/bin/bash
#SBATCH --job-name=MIMOSA_BASE23_TEST_INTERNAL
...
#SBATCH -e /homes/ocarpentiero/slurm/outerr/mimosa_base_23_test_internal.err
#SBATCH -o /homes/ocarpentiero/slurm/outerr/mimosa_base_23_test_internal.out
#SBATCH --gres=gpu:2
...
# Tests the brats23-trained mimosa_base checkpoints (folds 1/3/5) against
