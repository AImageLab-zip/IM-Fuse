#!/bin/bash
#SBATCH --job-name=TINYMIMOSA18_TEST
...
#SBATCH --mem=150G
#SBATCH --time=6:00:00
#SBATCH -e /homes/ocarpentiero/slurm/outerr/tinymimosa_18_test.err
#SBATCH -o /homes/ocarpentiero/slurm/outerr/tinymimosa_18_test.out
#SBATCH --gres=gpu:1
