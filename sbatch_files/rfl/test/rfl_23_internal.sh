#!/bin/bash
#SBATCH --job-name=RFL23_TEST_INTERNAL
...
#SBATCH -e /homes/ocarpentiero/slurm/outerr/rfl_23_test_internal.err
#SBATCH -o /homes/ocarpentiero/slurm/outerr/rfl_23_test_internal.out
#SBATCH --gres=gpu:1
...
# Tests the brats23-trained rfl checkpoints (folds 1/3/5) against
...
for trained_fold in 1 3 5; do
    mimose test \
        ...
        --fold 1 \
        --data-dir "$DATA_DIR" \
        --output-path "/work/phd_mimose/results/rfl_23/results_internal.txt"
done
