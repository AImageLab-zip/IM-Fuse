...
#SBATCH -e /homes/ocarpentiero/slurm/outerr/mmmvit_18_3.err
#SBATCH -o /homes/ocarpentiero/slurm/outerr/mmmvit_18_3.out
#SBATCH --gres=gpu:1
...
mimose test --config mmmvit_18.yaml --fold 3 --run-suffix fold3 --fp16
