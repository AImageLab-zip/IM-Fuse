...
#SBATCH --gres=gpu:1
#SBATCH --mem=80G
#SBATCH --job-name="train_RFNet"
#SBATCH --time=24:00:00
#SBATCH --output=/work/grana_neuro/missing_modalities/RFNet/slurm_out/train_RFNet_%j.out
...
python /work/grana_neuro/missing_modalities/RFNet/train.py \
    ...
    --num_epochs 300 \
    --dataname BRATS2023 \
    --savepath /work/grana_neuro/missing_modalities/RFNet/output \
    --batch_size 2 \
