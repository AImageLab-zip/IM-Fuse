...
val_check = [10, 30, 50, 90, 110, 130, 150, 170, 180, 190, 200, 210, 220, 230, 240, 245, 250, 255, 260, 265, 270, 275, 280, 285, 290, 295, 300] 
...
def main():
    ...
    wandb_name_and_id = f'{args.dataname}_rfnet_epoch{args.num_epochs}_iter{args.iter_per_epoch}_jobid{slurm_job_id}'
    if not args.debug:
        wandb.init(
