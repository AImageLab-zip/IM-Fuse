...
if __name__ == '__main__':
    ...
    datapath = '/work/grana_neuro/missing_modalities/BRATS2025__flipped_npy'
    test_file = 'datalist/test15splits2.csv'
    resume = '/work/grana_neuro/missing_modalities/MIFPN/output_23/output5/best.pth'
    num_cls = 4
    dataname = 'BRATS2025'
    ...
    flipped = True if 'flipped' in datapath else False
    output_path = f"eval/output_{dataname}_{flipped if flipped else ''}_{best_epoch}.txt"
