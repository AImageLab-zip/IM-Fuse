...
#SBATCH --gres=gpu:1
#SBATCH --mem=80G
#SBATCH --job-name="SRMNet18_eval"
#SBATCH --time=24:00:00
#SBATCH --output=/work/grana_neuro/missing_modalities/SRMNet/slurm_out18/eval18_SRMNet_%j.out
...
python /work/grana_neuro/missing_modalities/SRMNet/test.py \
    ...
    --resume /work/grana_neuro/missing_modalities/SRMNet/output18/output_2/best.pth