...
python /work/grana_neuro/missing_modalities/rfl/train.py \
    ...
    --num_epochs 1000 \
    --dataname BRATS2023 \
    --savepath /work/grana_neuro/missing_modalities/rfl/output9 \
    --batch_size 1 \
    --lr 2e-4 \
    --resume /work/grana_neuro/missing_modalities/rfl/output8/model_last.pth
