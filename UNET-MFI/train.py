...
def train_model(model, criterion, optimizer, dataload, val_loader,sche=None,num_epochs=1200,
    ...
    for epoch in range(start_epoch,num_epochs):
        ...
        epoch_loss = 0
        step = 0
        for x1,x2,x3,x4,y,mask_code in tqdm(dataload,total=len(dataload)):
            step += 1
...
def train():
    ...
    val_list = Path(__file__).parent / 'datalist' / 'val.txt'
    ...
    train_model(model, criterion, optimizer, train_loader,val_loader,sche=None,num_epochs=opt.num_epochs,
