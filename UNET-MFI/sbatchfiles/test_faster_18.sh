...
#SBATCH -e /homes/ocarpentiero/slurm/outerr/errunetmfitest.txt
...
python /homes/ocarpentiero/IM-Fuse/legacy/UNET-MFI/test_faster.py \
  ...
  --savepath /homes/ocarpentiero/results/test_unet_mfi_18.txt \
  --version brats18
